...
class Container(containers.DeclarativeContainer):
    ...
    # Agents
    code_review_agent = providers.Factory(CodeReviewAgent,
        llm_service = llm_service,
        prompt_service=prompt_service
    )

    conversation_agent = providers.Factory(ConversationAgent,
        llm_service = llm_service,
        prompt_service = prompt_service,
    ...
    document_loader_service = providers.Factory(DocumentLoaderService,
        vectordb_service=vectordb_service
    )
