...
from app.api.routers import auth, review, conversation, vector
...
app.include_router(vector.router, prefix = "/api/v1/vector-store", tags=["Vector Store"])
